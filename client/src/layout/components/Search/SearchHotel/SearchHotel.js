  ...
  return (
    <div className="absolute max-w-mw_11 w-w_10 left-2/4 translate-x-trans_x translate-y-trans_y">
      <div className="flex items-center bg-yellow-400 text-black h-14 p-1 rounded font-Nunito">
        <div className="flex items-center bg-white rounded flex-1 p-2 mr-1 focus-within:font-bold">
          <span className="pl-1">
            <svg
        ...
        <div className="flex items-center bg-white rounded flex-1 p-2 mr-1 ">
          ...
          {passengerData ? (
            <span className="w-full outline-0 px-2 py-1" type="datetime-local">
              ...
              {passengerData.childTickets} trẻ em · 1 phòng
            </span>
          ) : (
            <span className="w-full outline-0 px-2 py-1" type="datetime-local">
              người lớn · trẻ em · 1 phòng
            </span>
          )}
        </div>
